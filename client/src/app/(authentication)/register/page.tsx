...
// SUGGESTION:
// 1. Do NOT trust client state (Zustand/localStorage) for registration/auth access control.
// 2. On mount or after registration, call a backend API (e.g., /api/me or /api/session) to check user state (e.g., isEmailConfirmed, onboardingCompleted).
